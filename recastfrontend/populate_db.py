...
arxiv_1502_05686 = models.Analysis(
    ...
    collaboration='ATLAS',
    e_print='https://arxiv.org/abs/1502.05686',
    description='''
...
arxiv_1405_7875 = models.Analysis(
    ...
    collaboration='ATLAS',
    e_print='http://arxiv.org/abs/1405.7875',
    description='''
...
arxiv_1403_5294 = models.Analysis(
    ...
    collaboration='ATLAS',
    e_print='http://arxiv.org/abs/1403.5294',
    description='''
...
### for this point we will have a basic request:
josh_point_1_basic = models.BasicRequest(
    point_request_id=josh_point_1.id,
    requester_id=josh_ruderman.id
)
db.session.add(josh_point_1_basic)
db.session.commit()

### for which we have a file stored on AWS

josh_point_1_basic_file = models.RequestArchive(
    file_name = "0000-0000-nevents100-testfile-0001",
    path = '',
    zenodo_file_id = '',
    original_file_name = 'nevents100.zip',
    basic_request_id = josh_point_1_basic.id
    )
db.session.add(josh_point_1_basic_file)
db.session.commit()
